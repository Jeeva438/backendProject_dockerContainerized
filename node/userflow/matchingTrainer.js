...
router.get('/matchingTrainer', verifyTokenChecking, async (req, res) => {
    ...
    try {
        ...
        where tu.Lgn_type = 'U' and tu.isActive = 1 
        ...
        // }
        console.log("recordset", getMatching);
        ...
        return res.send({
            success: false,
            message: "Error while searching trainers",
            data: error.error
        })
    }
});
